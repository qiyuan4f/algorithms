 ...
 * @date 2012-06
 */
public class ISO7064Mod11_2Test {
	private CheckCoder checkCoder;
	private String testData = "33028319870101171";
	private int testCodeCorrect = 10;
	private Character testCodeCorrectString = 'X';
	private int testCodeError = 1;

	@Before
	public void setUp() throws Exception {
		checkCoder = new ISO7064Mod11_2();
	}
	...
	public void testCheck() throws Exception {
		// 含有正确的校验码的字符串
		Assert.assertTrue(checkCoder.check(testData + testCodeCorrectString));
	...
	public void testDecode() throws Exception {
		Map<String, Object> ret = checkCoder.decode(testData + testCodeCorrectString);
	...
	public void testGetCode() throws Exception {
		Assert.assertEquals(testCodeCorrect, checkCoder.getCode(testData + testCodeCorrectString));
		Assert.assertNotSame(testCodeCorrect, checkCoder.getCode(testData + testCodeError));
	}

	@Test
	public void testGetData() throws Exception {
		Assert.assertEquals(testData, checkCoder.getData(testData + testCodeCorrectString));
